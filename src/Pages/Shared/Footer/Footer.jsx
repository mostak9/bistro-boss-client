const Footer = () => {
  ...
  return (
    <div>
      <footer className="flex flex-col md:flex-row items-center justify-center p-10 bg-neutral text-neutral-content">
        <aside className="text-center flex flex-col items-center gap-6 pb-5 md:pb-0 md:pr-24">
        ...
        <nav className="flex items-center flex-col pt-5 md:pb-0 md:pl-24">
